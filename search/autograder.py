...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP, edxOutput=False, muteOutput=False,
            printTestCase=False, questionToGrade=None, display=None, autolabOutput=False):
    ...
    grades = grading.Grades(projectParams.PROJECT_NAME, questions, edxOutput=edxOutput, muteOutput=muteOutput, autolabOutput=autolabOutput)
...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        ...
        evaluate(options.generateSolutions, options.testRoot, moduleDict,
            ...
            questionToGrade=options.gradeQuestion, display=getDisplay(options.gradeQuestion!=None, options), autolabOutput=options.autolabOutput)
